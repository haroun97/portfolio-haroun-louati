    ...
    <div className="min-h-screen bg-white dark:bg-portfolio-blue-dark">
      ...
      <section className="py-16 px-6 bg-gray-50 dark:bg-portfolio-blue-dark/70">
        <div className="container mx-auto max-w-5xl">
          ...
          {/* Main Robot Image */}
          <div className="mb-16">
            <h3 className="text-2xl font-semibold mb-8 text-center dark:text-white">Control Interface</h3>
            <Card className="overflow-hidden">
              <div className="relative">
                <AspectRatio ratio={16 / 9}>
                  <div className="w-full h-full flex items-center justify-center bg-portfolio-blue-dark/10">
                    <Smartphone size={64} className="text-portfolio-blue-light opacity-40" />
                  </div>
                </AspectRatio>
              </div>
              <CardContent className="p-4">
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  The control interface allows users to operate the robot arm through multiple input methods.
                </p>
              </CardContent>
            </Card>
          </div>
