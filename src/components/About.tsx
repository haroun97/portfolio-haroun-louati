        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-1/2">
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              ...
              <p>
                I hold a Master's Degree in Computer Science, Tunisia, and a Bachelor's Degree in Electrical Engineering. These programs provided me with a strong foundation in both software development and engineering principles.
              </p>
              <p>
